...
- (id)init {
    ...
    if (self) {
        ...
        [atBtn setTitleColor:[Shared bbYellow] forState:UIControlStateHighlighted];
        ...
        [topicBtn setTitleColor:[Shared bbYellow] forState:UIControlStateHighlighted];
...
- (void)back {
    delegate.window.backgroundColor = [Shared bbYellow];
