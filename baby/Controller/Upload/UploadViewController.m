...
- (id)init {
    ...
    if (self) {
        ...
        singleBtn.backgroundColor = [Shared bbYellow];
        ...
        multiBtn.layer.borderColor = [Shared bbYellow].CGColor;
        multiBtn.layer.borderWidth = 2;
        multiBtn.backgroundColor = [UIColor whiteColor];
        [multiBtn setTitleColor:[Shared bbYellow] forState:UIControlStateNormal];
