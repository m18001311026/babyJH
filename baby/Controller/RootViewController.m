...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        TabbarItem *item1 = [[TabbarItem alloc] initWithFrame:CGRectMake(0, 2, tabbarItemwidth, 42)
                                                        title:@"首页"
                                                  normalImage:@"tab_home_n.png"
                                            hightlightedImage:@"tab_home_h.png"
        ...
        _item2 = [[TabbarItem alloc] initWithFrame:CGRectMake(1*tabbarItemwidth, 2, tabbarItemwidth, 42)
                                                        title:@"我的"
                                                  normalImage:@"tab_me_n.png"
                                            hightlightedImage:@"tab_me_h.png"
                                                  normalColor:normalColor
                                            hightlightedColor:[UIColor applicationYellowColor]
                                                        index:1];
        [self addItem:_item2];
        ...
        TabbarItem *item3 = [[TabbarItem alloc] initWithFrame:CGRectMake(2*tabbarItemwidth, 2, tabbarItemwidth, 42)
                                                        title:@"发布"
                                                  normalImage:@"tab_post_n.png"
        ...
        _item4 = [[TabbarItem alloc] initWithFrame:CGRectMake(3*tabbarItemwidth, 2, tabbarItemwidth, 42)
                                                        title:@"发现"
                                                  normalImage:@"tab_cart_h1.png"
                                            hightlightedImage:@"tab_cart_n1.png"
                                                  normalColor:normalColor
                                            hightlightedColor:[UIColor applicationYellowColor]
                                                        index:3];
        [_item4 setBadge:nil];
        ...
        TabbarItem *item5 = [[TabbarItem alloc] initWithFrame:CGRectMake(4*tabbarItemwidth, 2, tabbarItemwidth, 42)
                                                        title:@"课堂"
                                                  normalImage:@"tab_lesson_n.png"
                                            hightlightedImage:@"tab_lesson_h.png"
                                                  normalColor:normalColor
                                            hightlightedColor:[UIColor applicationYellowColor]
                                                        index:4];
        [self addItem:item5];
        [item5 release];
        [self setViewController:@"LessonViewController" params:nil atIndex:4];
