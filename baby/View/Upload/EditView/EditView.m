...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        line.backgroundColor = [Shared bbYellow];
        [self addSubview:line];
        [line release];
        
        modeSwitchBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        modeSwitchBtn.frame = CGRectMake(12, 12, 36, 36);
        [modeSwitchBtn setTitleColor:[Shared bbYellow] forState:UIControlStateNormal];
        modeSwitchBtn.layer.borderColor = [Shared bbYellow].CGColor;
        [modeSwitchBtn setTitle:@"字" forState:UIControlStateNormal];
        ...
        inputView.layer.borderColor = [Shared bbYellow].CGColor;
      ...
      //  [self addSubview:inputView];
        ...
        voiceBtn.backgroundColor = [Shared bbYellow];
...
//           forControlEvents:UIControlEventTouchDragInside];
        ...
        delBtn.backgroundColor = [Shared bbYellow];
