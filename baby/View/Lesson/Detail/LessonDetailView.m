...
- (id)initWithFrame:(CGRect)frame lesson:(long)lessonId {
    ...
    if (self) {
        ...
        priceUnit.textColor = [Shared bbYellow];
        ...
        price.textColor = [Shared bbYellow];
...
//        posY += 5;
        ...
        bar.backgroundColor = [Shared bbYellow];
        ...
        [buy setTitleColor:[Shared bbYellow] forState:UIControlStateNormal];
        ...
        cart.backgroundColor = [Shared bbYellow];
