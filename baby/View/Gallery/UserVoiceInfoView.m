...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIImageView *bg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"voice_info.png"]];
        bg.frame = CGRectMake(10, 2, 140, 64);
        [self addSubview:bg];
        [bg release];
        ...
        ageLabel = [[UILabel alloc] initWithFrame:CGRectMake(101, 33, 46, 14)];
